...
(function() {
  'use strict';
console.log('mapbox');
  angular.module('angular-mapbox').service('mapboxService', [function() {
      var _mapInstances = [],
          _markers = [],
          _mapOptions = [];
...
(function() {
  ...
  angular.module('angular-mapbox').directive('mapbox', ['$compile', '$q', 'mapboxService',function($compile, $q, mapboxService) {
      var _mapboxMap;
  console.log('mapbox2');
      return {
        restrict: 'E',
        ...
        controller: ['$scope', 'mapboxService', function($scope, mapboxService) {
...
(function() {
  ...
  angular.module('angular-mapbox').directive('marker', ['$compile', '$timeout', 'mapboxService',function($compile, $timeout, mapboxService) {
      var _colors = {
        navy: '#001f3f',
        blue: '#0074d9',
        aqua: '#7fdbff',
